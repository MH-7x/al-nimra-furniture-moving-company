      ...
      <section className="relative overflow-hidden px-4 pt-12 pb-0">
        <div className="relative max-w-5xl mx-auto">
          ...
          <p className="text-muted-foreground text-base md:text-lg leading-relaxed max-w-2xl mb-8">
            إذا كنت تبحث عن شركة نقل اثاث راس الخيمة موثوقة، فإن <strong>نقل اثاث راس الخيمة</strong> مع النمرة يعني فريقاً
            يعرف مناطق الإمارة من النخيل لين شعم. نحن شركة متخصصة نشتغل بفريق ثابت وشاحنات مغلقة ومواد تغليف نجيبها معنا. ما نطلب منك
      ...
      <section className="py-14 px-4">
        <div className="max-w-3xl mx-auto space-y-6">
          <p className="text-muted-foreground text-base md:text-lg leading-relaxed">
            سواء كنت تقارن بين شركات نقل أثاث مختلفة أو تنقل داخل راس الخيمة — من شقة في النخيل لفيلا في الحمرا أو من
        ...
        <div className="max-w-6xl mx-auto">
          <div className="mb-10">
            ...
            <p className="text-white/70 max-w-4xl text-sm md:text-base leading-relaxed">
              تتميز النمرة بكونها من أفضل شركات نقل الاثاث في المنطقة، ففي راس الخيمة تتنافس العديد من شركات نقل الأثاث المحلية. بعضها يشتغل بعمالة يومية ويختفي بعد
              النقل لو صار أي مشكلة. وبعضها ينسخ محتوى صفحة أبوظبي ويحطه على
              صفحة راس الخيمة بدون ما يعرف شي عن الإمارة. الفرق بيننا وبين بقية الشركات واضح من
            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-8 relative z-10">
              {[
                ...
                },
                {
                  ...
                  desc: "بعد المعاينة نرسل لك عرض سعر ثابت وواضح خلال ساعة على الواتساب. العرض يوضح كل تفاصيل خدمة النقل: عدد العمال، عدد الشاحنات، الخدمات المشمولة، والسعر النهائي. لو وافقت، نحجز لك الموعد ونأكد الليلة اللي قبل يوم النقل عشان تكون متأكد إن كل شي جاهز.",
                  icon: MessageCircle,
                },
                {
                  step: "03",
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="mb-10 text-center">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto text-sm md:text-base leading-relaxed">
              عمليات نقل الأثاث في رأس الخيمة تتطلب معرفة بالإمارة لتنوعها الجغرافي الفريد — ساحل
              وجبال وبلدة قديمة ومناطق حرة ومجتمعات سياحية. حماية الأثاث في رأس الخيمة في كل هالتنوع تتطلب خبرة، وبعد سنين من الشغل تعلمنا
              نتعامل مع كل التحديات بطريقة عملية.
            </p>
          </div>
