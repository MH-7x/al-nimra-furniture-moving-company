...
import { alainFaqs } from "@/lib/FaqsData";
...
export const metadata = MetadataTemplate({
  meta: {
    title: "نقل اثاث العين | النمرة نقل اثاث - أسعار تبدأ من 600 درهم",
    desc: " شركة النمره نقل اثاث العين - فك وتركيب وتغليف ونقل مع تأمين شامل. معاينة مجانية وعرض سعر فوري. اتصل الآن 0541767605",
  },
...
export default function AlAinMovingPage() {
  return (
    <main dir="rtl" className="text-foreground pb-20">
      ...
      <section className="relative overflow-hidden px-4 pt-12 pb-0">
        <div className="relative max-w-5xl mx-auto">
          ...
          <p className="text-muted-foreground text-base md:text-lg leading-relaxed max-w-2xl mb-8">
            تحتاج نقل اثاث العين وما تعرف من وين تبدأ؟ النمرة نقل اثاث تقدم
            خدمات نقل اثاث في العين بخبرة أكثر من 10 سنوات في السوق الإماراتي.
            فريقنا يتولى كل شيء من أول لحظة: الفك، التغليف، النقل، والتركيب في
            المكان الجديد. نغطي جميع مناطق العين من الهيلي والجيمي إلى المقام
            وزاخر والفوعة. أرسل رسالة واتساب على الرقم 0541767605 واحصل على عرض
          ...
          <div className="w-full aspect-video rounded-t-3xl overflow-hidden relative border-x border-t border-muted">
            <Image
              src="/aln/نقل-اثاث-العين-النمره-جبل-حفيت.jpg"
              alt="النمرة نقل اثاث نقل اثاث في العين - شاحنة نقل أثاث أمام فيلا مع فريق عمل محترف"
              fill
      ...
      {/* ══════════════════════════════════════════
          WHY CHOOSE US (لماذا تختار النمرة نقل اثاث لنقل اثاث العين؟)
      ══════════════════════════════════════════ */}
      ...
      <section className="py-16 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="space-y-6">
            ...
            <article className="grid grid-cols-1 md:grid-cols-2 gap-0 rounded-3xl overflow-hidden border border-muted">
              <div className="p-8 md:p-10 flex flex-col justify-center order-2 md:order-1">
                ...
                <p className="text-muted-foreground text-sm leading-relaxed mb-4">
                  سواء عندك استوديو صغير أو شقة 3 غرف، نتعامل مع كل حجم. الفريق
                  يجي في الموعد، يفك الاثاث، يغلف كل قطعة، وينقل كل شيء إلى
                  الشقة الجديدة. بعد التوصيل، النجار يركب الاثاث ويتأكد إن كل
                  شيء في مكانه.
                </p>
                <p className="text-muted-foreground text-sm leading-relaxed mb-5">
                  كثير من عملاءنا في العين يسكنون in شقق مفروشة جزئيا ويحتاجون
                  ينقلون أغراضهم الشخصية مع بعض قطع الاثاث. نتعامل مع هالحالات
                  بمرونة وما نفرض باقة ثابتة. عندنا عاملات سيدات متوفرات لمن
                  يحتاج مساعدة في تغليف الملابس والأغراض الشخصية.
                </p>
                <Link
              ...
              {/* Image */}
              <div className="aspect-[4/3]  relative order-1 md:order-2 min-h-[220px]">
                <Image
            ...
            <article className="grid grid-cols-1 md:grid-cols-2 gap-0 rounded-3xl overflow-hidden border border-muted">
              {/* Image */}
              <div className="aspect-[4/3]  relative min-h-[220px]">
                <Image
              ...
              <div className="p-8 md:p-10 flex flex-col justify-center">
                ...
                <p className="text-muted-foreground text-sm leading-relaxed mb-4">
                  نقل اثاث الفلل في العين يختلف عن الشقق. الاثاث أكبر وأثقل،
                  والأدوار أكثر، وعادة فيه حديقة ومطبخ كبير ومجلس منفصل. عندنا
                  معدات خاصة للقطع الثقيلة مثل الخزائن الكبيرة وطاولات الطعام
                  الرخامية والكنب العريض اللي ما يمر من الباب بسهولة. إذا عندك
                  بيانو أو خزنة، عندنا فريق متخصص يتعامل معها بأدوات رفع مخصصة.
                </p>
                <p className="text-muted-foreground text-sm leading-relaxed mb-5">
                  أغلب فلل العين في مناطق مثل الهيلي والمقام وزاخر فيها مواقف
                  واسعة للشاحنات، وهذا يسهل عملية التحميل. لكن بعض الفلل القديمة
                  في الجيمي والخبيصي الشوارع فيها أضيق. فريقنا يعرف هالتفاصيل
                  ويجهز حسب الموقع. الفلل تاخذ عادة يوم كامل حسب عدد الغرف،
                  ونعطيك جدول زمني واضح قبل ما نبدأ.
                </p>
                <Link
            ...
            <article className="grid grid-cols-1 md:grid-cols-2 gap-0 rounded-3xl overflow-hidden border border-muted">
              <div className="p-8 md:p-10 flex flex-col justify-center order-2 md:order-1">
                ...
                <p className="text-muted-foreground text-sm leading-relaxed mb-5">
                  نقل المكتب يختلف عن نقل المنزل. فيه أجهزة كمبيوتر وخوادم
                  وطابعات ومستندات مهمة ما تقدر تخسرها. فريقنا مدرب على التعامل
                  مع معدات تكنولوجيا المعلومات وتغليفها بالفوم المضاد للصدمات.
                  نقدر ننقل مكتبك في عطلة نهاية الأسبوع أو بعد ساعات الدوام حتى
                  ما يتأثر عملك ولا يتوقف يوم واحد. نرقم كل صندوق ونكتب عليه اسم
                  القسم حتى يسهل الترتيب في المكتب الجديد. شركات ومكاتب العين في
                  منطقة السوق وشارع خليفة ومنطقة الصناعية كلها ضمن نطاق خدمتنا.
                </p>
                <Link
            ...
            <article className="grid grid-cols-1 md:grid-cols-2 gap-0 rounded-3xl overflow-hidden border border-muted">
              <div className="aspect-video  relative min-h-[220px]">
                <Image
                  src="/aln/فك-تغليف-تركيب-اثاث-العين-النمره.jpg"
                  alt="خدمة فك وتغليف وتركيب الأثاث في العين - نجار النمرة نقل اثاث"
                  fill
                  className="object-cover"
                />
              </div>
              <div className="p-8 md:p-10 flex flex-col justify-center">
                ...
                <p className="text-muted-foreground text-sm leading-relaxed mb-4">
                  النجارين عندنا يتعاملون مع كل أنواع الاثاث. سواء كان اثاث
                  ايكيا أو تفصيل خاص أو إيطالي فاخر، يفكونه بدون أي ضرر ويركبونه
                  في المكان الجديد كما كان. اثاث ايكيا بالذات يحتاج حذر لأن
                  البراغي لو انكسرت ما تنفع تتركب مرة ثانية. عمالنا عندهم خبرة
                  طويلة في هالنوع ويعرفون ترتيب الفك والتركيب.
                </p>
                <p className="text-muted-foreground text-sm leading-relaxed mb-5">
                  نقوم أيضا بتركيب الستائر والسجاد وتعليق التلفزيونات على
                  الجدران. إذا عندك ثريا كبيرة أو رفوف جدارية، الفريق يتولاها.
                  هالخدمات متضمنة في سعر نقل اثاث العين ولا تحتاج تدفع مبلغ
                  إضافي عليها إلا في حالات خاصة مثل تركيب المطبخ الكامل.
                </p>
                <Link
            ...
            <article className="rounded-3xl overflow-hidden border border-muted p-8 md:p-10 bg-slate-50">
              ...
              <p className="text-muted-foreground text-sm md:text-base leading-relaxed mb-4">
                كل غرض له مادة تغليف مختلفة. البابل راب (غلاف الفقاعات) للأشياء
                الهشة مثل الزجاج والمرايا والصحون. الفيلم المطاط لتثبيت أبواب
                الخزائن والأدراج. بطانيات القماش للأثاث الخشبي لمنع الخدوش.
                الكراتين القوية (5 طبقات) للملابس وأدوات المطبخ والكتب. والألواح
                الحرارية توضع بين القطع داخل الشاحنة لحماية إضافية أثناء النقل.
              </p>
              <Link
            ...
            <article className="grid grid-cols-1 md:grid-cols-2 gap-0 rounded-3xl overflow-hidden border border-muted">
              <div className="p-8 md:p-10 flex flex-col justify-center order-2 md:order-1">
                ...
                <p className="text-muted-foreground text-sm leading-relaxed mb-5">
                  أحيانا تحتاج مكان تخزن فيه أثاثك لفترة. ربما بين شقتين، أو
                  خلال تجديد المنزل، أو لأنك مسافر لشهرين وما تبي تدفع إيجار
                  فاضي. نوفر وحدات تخزين مكيفة وآمنة لفترات قصيرة وطويلة. أغراضك
                  تبقى بحالتها لحد ما تجهز مكانك الجديد. كثير من اللي يطلبون نقل
                  اثاث العين يحتاجون تخزين مؤقت لأسبوع أو أسبوعين بين تسليم
                  الشقة القديمة واستلام الجديدة.
                </p>
                <Link
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
            <div>
              ...
              <p className="text-muted-foreground text-sm leading-relaxed mb-4">
                واحد من أكثر الأسئلة اللي نسمعها: كم تكلفة نقل اثاث العين؟
                الجواب يعتمد على حجم الاثاث والمسافة والطابق وعدد القطع الخاصة.
                لكن حتى نعطيك فكرة واضحة، هذا جدول تقريبي مبني على أسعار
                خدماتنا:
              </p>
              <p className="text-muted-foreground text-sm leading-relaxed mb-4">
                <strong>ملاحظة:</strong> الأسعار تتغير حسب عدد الطوابق، توفر
                المصعد، نوع الاثاث، والمسافة بين الموقعين. أرسل لنا رسالة واتساب
                أو اتصل على 0541767605 للحصول على سعر دقيق بعد المعاينة
                المجانية. ما فيه رسوم خفية.
              </p>
              <p className="text-muted-foreground text-sm leading-relaxed mb-4">
                أسعار نقل اثاث العين بشكل عام أقل من أسعار دبي وأبوظبي لأن تكلفة
                المعيشة في المدينة أقل. لكن النقل بين الإمارات (مثلا من العين
                إلى دبي) يضيف تكلفة المسافة والوقود. ننصح دايما بالمعاينة
                المجانية لأنها تعطيك السعر الحقيقي بدون مفاجآت يوم النقل.
              </p>
              ...
              <div className="space-y-2 mt-4 text-sm text-muted-foreground bg-slate-50 p-5 rounded-2xl border border-muted">
                ...
                <ul className="list-disc list-inside space-y-1.5">
                  ...
                  <li>
                    التغليف: إذا عندك أغراض هشة كثيرة مثل التحف والمرايا
                    الكبيرة، التغليف ياخذ وقت ومواد أكثر
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="space-y-6">
                    ...
                    {[
                      {
                        ...
                        crew: "3-4",
                        trucks: "1",
                        price: "600 - 1,000 درهم",
                      },
                      {
                        type: "غرفة وصالة",
                        crew: "4",
                        trucks: "1",
                        price: "800 - 1,200 درهم",
                      },
                      {
                        type: "غرفتين وصالة",
                        crew: "4-5",
                        trucks: "1-2",
                        price: "1,000 - 1,700 درهم",
                      },
                      {
                        type: "فيلا غرفتين",
                        crew: "4-6",
                        trucks: "1-2",
                        price: "1,200 - 1,800 درهم",
                      },
                      {
                        type: "فيلا 3 غرف",
                        crew: "6-7",
                        trucks: "1-2",
                        price: "1,800 - 2,500 درهم",
                      },
                      {
                        type: "فيلا 4-5 غرف",
                        crew: "7-10",
                        trucks: "2-3",
                        price: "2,500 - 4,000 درهم",
                      },
                      {
                        type: "نقل مكتب صغير",
                        crew: "4-5",
                        trucks: "1",
                        price: "1,000 - 1,500 درهم",
                      },
                    ].map((row, i) => (
                      <tr
                        key={i}
              ...
              <div className="flex items-start gap-2 text-sm text-muted-foreground">
                ...
                <p className="leading-relaxed">
                  الأسعار نهائية ولا توجد بها رسوم إضافية مخفية. ننصحك بالمعاينة
                  المجانية أو إرسال تفاصيل الأثاث عبر الواتساب.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="mb-10">
            ...
            <p className="text-muted-foreground max-w-2xl text-sm md:text-base leading-relaxed">
              واحد من الأسباب اللي تخلي الناس يترددون في نقل اثاث العين هو إنهم
              ما يعرفون إيش بيصير بالضبط. عندنا العملية واضحة ومرتبة من أول
              اتصال لحد ما تستلم بيتك الجديد:
            </p>
          </div>
          ...
          <div className="mt-8 border-t border-muted pt-6 space-y-4">
            <p className="text-muted-foreground text-sm leading-relaxed max-w-4xl">
              هالخطوات تنطبق على كل أنواع النقل: شقة صغيرة، فيلا كبيرة، أو مكتب.
              الفرق الوحيد هو عدد العمال وحجم الشاحنات. العملية نفسها ما تتغير
              لأنها مبنية على سنوات من التجربة في نقل اثاث العين وباقي الإمارات.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="mb-8">
            ...
            <p className="text-muted-foreground text-sm md:text-base leading-relaxed max-w-2xl">
              نقدم خدمات نقل اثاث العين في جميع مناطقها بدون استثناء. فريقنا
              يعرف شوارع المدينة ومداخل المجمعات السكنية وأماكن وقوف الشاحنات.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm text-muted-foreground border-t border-muted pt-6">
            <div className="space-y-4">
              <p>
                لكل منطقة في العين خصوصيتها. بعض المناطق فيها فلل كبيرة تحتاج
                شاحنات أكبر مثل الهيلي والمقام. ومناطق مثل الجيمي والخبيصي فيها
                شقق أكثر ومباني متعددة الطوابق. فريقنا يعرف أماكن مواقف الشاحنات
                وأوقات الذروة في كل منطقة.
              </p>
              <p>
                منطقة زاخر مثلا فيها مجمعات سكنية حكومية كبيرة، والنقل فيها
                يحتاج تنسيق مسبق مع إدارة المجمع. منطقة الفوعة والمسعودي فيها
                فلل واسعة وعادة الشاحنة توقف قريب من الباب. المناطق الصناعية مثل
                منطقة الهيلي الصناعية نتعامل معها لنقل المكاتب والمستودعات.
              </p>
            </div>
            <div className="space-y-4">
              <p className="font-semibold text-secondary-foreground text-base">
                إذا كنت ساكن في منطقة ما ذكرناها، تواصل معنا. نغطي كل العين بلا
                استثناء.
              </p>
            </div>
          </div>
          ...
          <div className="mt-12 border-t border-muted pt-10">
            ...
            <p className="text-muted-foreground text-sm leading-relaxed mb-6 max-w-3xl">
              إذا كنت تنتقل من العين إلى إمارة ثانية، نغطي هذه المسارات بشكل
              يومي ونوفر نفس مستوى التأمين والجودة. الشاحنات مغلقة ومكيفة وتحمي
              أثاثك على الطرق السريعة الطويلة:
            </p>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
              {[
                ...
                <div
                  key={i}
                  className="bg-white border border-muted rounded-3xl p-6 flex flex-col justify-between shadow-sm"
                >
                  <div>
                  ...
                  <div className="mt-4">
                    <Link
                      href={
                        p.route.includes("دبي")
                          ? "/"
                          : p.route.includes("الشارقة")
                            ? "/نقل-أثاث-الشارقة"
                            : "/نقل-اثاث-ابوظبي"
                      }
                      className="text-xs font-bold text-primary hover:underline flex items-center gap-1"
                    >
                      تصفح فرع الإمارات الأخرى{" "}
            ...
            <p className="text-muted-foreground text-sm leading-relaxed">
              الخدمة والتأمين نفس الشيء سواء كان النقل داخل العين أو بين
              الإمارات. كثير من عملاءنا ينقلون من العين إلى دبي بسبب تغيير
              العمل، أو من دبي إلى العين للسكن بأسعار أقل. في كلا الاتجاهين،
              نوفر نفس مستوى نقل اثاث العين اللي اعتدت عليه.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="mb-10">
            ...
            <p className="text-muted-foreground text-sm md:text-base leading-relaxed max-w-2xl">
              من واقع تجربتنا في نقل عفش العين على مدار سنوات، هذي أشياء تسهل
              عليك عملية النقل وتوفر عليك وقت ومال:
            </p>
          </div>
      ...
      <section className="py-16 px-4 bg-slate-50 border-y border-muted">
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          <p className="text-muted-foreground text-sm md:text-base leading-relaxed">
            العين من أحر المدن في الإمارات. في يوليو وأغسطس، الحرارة توصل 48 إلى
            50 درجة. هذا يأثر على الاثاث أكثر مما يتوقع الناس.
          </p>
          <p className="text-muted-foreground text-sm md:text-base leading-relaxed">
            الخشب يتمدد ويتقوس في الحرارة العالية. الجلد يتشقق. الأجهزة
            الالكترونية ترتفع حرارتها. حتى المواد اللاصقة في بعض قطع الاثاث ممكن
            تضعف.
          </p>
          <p className="text-muted-foreground text-sm md:text-base leading-relaxed">
            عشان كذا نستخدم شاحنات مغلقة ومكيفة. الاثاث يبقى في بيئة معتدلة طوال
            الرحلة. ونضع ألواح حرارية عازلة بين القطع داخل الشاحنة.
          </p>
          <p className="text-muted-foreground text-sm md:text-base leading-relaxed">
            في الصيف، ننصح بالنقل في الفترة من 6 صباحا إلى 11 صباحا. الحرارة
            تكون أقل، والفريق يشتغل بكفاءة أعلى.
          </p>
          <p className="text-muted-foreground text-sm md:text-base leading-relaxed">
            العواصف الرملية أيضا شيء نتعامل معه في العين. الشاحنات المغلقة تحمي
            أثاثك من الرمل والغبار اللي ممكن يخدش الأسطح أو يدخل في الأجهزة
            الالكترونية.
          </p>
          <p className="text-muted-foreground text-sm md:text-base leading-relaxed">
            إذا كنت تخطط لـ نقل اثاث العين في شهر يونيو أو يوليو أو أغسطس، احجز
            قبل أسبوعين على الأقل. هالفترة فيها طلب عالي لأن كثير من عقود
            الإيجار تنتهي مع نهاية العام الدراسي. الحجز المبكر يضمن لك الموعد
            والسعر.
          </p>
          <p className="text-muted-foreground text-sm md:text-base leading-relaxed">
            شيء ما يفكرون فيه كثير: حتى الأجهزة الالكترونية مثل التلفزيونات
            وأجهزة الكمبيوتر تتأثر بالحرارة. إذا تركت تلفزيون 65 بوصة في بيك أب
            مفتوح تحت الشمس ساعة، الشاشة ممكن تتضرر من الداخل. الشاحنة المكيفة
            تحل هالمشكلة تماما.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="mb-10">
            ...
            <p className="text-muted-foreground text-center text-sm md:text-base leading-relaxed max-w-2xl mx-auto">
              إذا كتبت &quot;نقل اثاث العين&quot; في قوقل، بتطلع لك عشرات
              الشركات. بعضها ممتاز وبعضها ما يستاهل. الفرق بينهم مش دايما واضح
              من الإعلان. هذي معايير تساعدك تختار صح:
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              {
                title: "التراخيص",
                desc: "تأكد إن الشركة مسجلة ومرخصة لنقل الاثاث. الشركات غير المرخصة ما عندها التزام قانوني تجاهك إذا صار ضرر.",
              },
              {
                title: "التأمين",
                desc: "اسأل عن تفاصيل التأمين. إيش يغطي بالضبط؟ هل التعويض يكون بالإصلاح أو الاستبدال؟ خذ الجواب مكتوب.",
              },
              {
                title: "المعاينة المجانية",
                desc: "الشركة المحترفة ما تعطيك سعر من غير ما تشوف الاثاث. إذا شركة أعطتك سعر بالتلفون بدون ما تجي تشوف، توقع مفاجآت.",
              },
              {
                title: "حالة الشاحنات",
                desc: "الشاحنات المغلقة هي المعيار. البيك أب المفتوح مناسب لنقل قطعة أو قطعتين، لكن مش لنقل بيت كامل.",
              },
              {
                title: "آراء العملاء",
                desc: "شوف التقييمات على قوقل. اقرأ التعليقات السلبية بالذات لأنها تعطيك صورة حقيقية عن مشاكل الشركة.",
              },
              {
                title: "سياسة الدفع",
                desc: "الشركة اللي تطلب دفعة مقدمة كبيرة قبل ما تبدأ الشغل، فكر مرتين. في النمرة نقل اثاث، الدفع يكون بعد الانتهاء من كل شيء وبعد ما تتأكد إن أثاثك سليم.",
              },
              {
                title: "اسأل عن المعدات",
                desc: "الشركة اللي تنقل بيت كامل ببيك أب مفتوح وبدون مواد تغليف، النتيجة معروفة. اسأل عن نوع الشاحنات ومواد التغليف قبل ما توافق.",
              },
              {
                title: "خذ أكثر من عرض سعر",
                desc: "تواصل مع 3 شركات نقل اثاث في العين على الأعل وقارن. مش بس السعر، قارن إيش يشمل السعر. بعض الشركات تعطيك سعر رخيص لكن التغليف والتركيب والنظافة كلها إضافية. اسأل: هل السعر يشمل الفك والتركيب والتغليف والنقل والتنظيف؟ عندنا في النمرة نقل اثاث الجواب نعم على كل هالأشياء.",
              },
            ].map((c, i) => (
              <div
                key={i}
        ...
        <div className="max-w-6xl mx-auto">
          <div className="mb-10 text-center">
            ...
            <p className="text-muted-foreground text-sm md:text-base leading-relaxed max-w-2xl mx-auto">
              من خلال شغلنا في نقل الاثاث بالعين، شفنا أخطاء كثير يقع فيها الناس
              وتكلفهم فلوس أو اثاث. خلني أذكر لك أكثرها تكرار:
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
            {[
              {
                title: "الاعتماد على عمال بدون شركة",
                desc: "بعض الناس يجيبون عمال من الشارع ويستأجرون بيك أب. السعر يطلع أرخص فعلا، لكن ما فيه تأمين، ما فيه مسؤولية، وإذا انكسر شيء ما تقدر ترجع لأحد. شفنا حالات كثيرة الناس تتصل فينا بعد ما جربت هالطريقة وخسرت قطع أثاث غالية.",
              },
              {
                title: "النقل بدون تغليف",
                desc: "حتى لو المسافة قصيرة، الاثاث يتحرك داخل الشاحنة ويصطدم ببعض. خدش واحد على طاولة خشبية يكلف إصلاحه أكثر من تكلفة التغليف كله.",
              },
              {
                title: "ما يفحصون الاثاث قبل وبعد",
                desc: "لازم تصور كل قطعة قبل النقل وتفحصها بعد التوصيل. هالشيء يحميك ويحمي الشركة.",
              },
              {
                title: "ينقلون في وقت الذروة بدون حجز مسبق",
                desc: "آخر الشهر وبداية الصيف هي أكثر فترات الطلب على نقل الاثاث في العين. إذا ما حجزت قبل أسبوع أو أسبوعين، ممكن ما تلاقي موعد مناسب أو تدفع أكثر.",
              },
              {
                title: "ينسون يبلغون المبنى",
                desc: "المصعد محجوز، الأمن ما يسمح بدخول الشاحنة، والنتيجة تأخير ساعات. اتصل بإدارة المبنى قبل يوم النقل بيومين على الأقل.",
              },
            ].map((e, i) => (
              <div
                key={i}
                className="bg-white border border-muted rounded-3xl p-6 shadow-sm hover:border-primary/20 transition-all flex flex-col justify-between"
              >
                <div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="rounded-3xl border-2 border-dashed border-primary/20 bg-primary/3 p-10 md:p-14 text-center">
            ...
            <p className="text-muted-foreground text-sm md:text-base leading-relaxed mb-4 max-w-3xl mx-auto">
              تبي تنقل قريب؟ سواء كنت تنقل داخل العين أو من العين لإمارة ثانية،
              كلمنا واحصل على سعرك خلال دقائق. نقلنا أثاث أكثر من ألف عائلة في
              العين. أثاثك يوصل سليم والسعر هو نفس اللي اتفقنا عليه من البداية.
            </p>
