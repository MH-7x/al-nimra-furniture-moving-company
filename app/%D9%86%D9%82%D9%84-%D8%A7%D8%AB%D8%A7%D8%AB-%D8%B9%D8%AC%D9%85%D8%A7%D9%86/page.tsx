      ...
      <section className="relative overflow-hidden px-4 pt-12 pb-0">
        <div className="relative max-w-5xl mx-auto">
          ...
          <p className="text-muted-foreground text-base md:text-lg leading-relaxed max-w-2xl mb-8">
            إذا كنت تبحث عن شركة متخصصة في <strong>نقل اثاث عجمان</strong>، فإن شركة النمرة هي الاختيار الأمثل حيث يمكنك الاعتماد على فريق يعرف شوارع عجمان وبناياتها ومناطقها من سنين. نشتغل بفريق ثابت وشاحنات مغلقة ومواد تغليف نجيبها معنا بدون تكاليف إضافية.
          </p>
      ...
      <section className="py-14 px-4">
        <div className="max-w-3xl mx-auto space-y-6">
          <p className="text-muted-foreground text-base md:text-lg leading-relaxed">
            يسعدنا دايمًا مساعدتك في نقل ممتلكاتك والأثاث والقطع الخاصة بك بأمان تام داخل عجمان — من النعيمية للراشدية أو من شقة برج لفيلا في
            الجرف — أو من عجمان لدبي والشارقة. عجمان إمارة فيها حركة سكنية نشطة، ونحن متواجدون يوميًا لضمان وصول منقولاتك بسلامة وسلاسة.
          </p>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="mb-10">
            ...
            <p className="text-white/70 max-w-4xl text-sm md:text-base leading-relaxed">
              تلتزم النمرة في تقديم خدمات نقل الأثاث بأعلى مستويات الجودة والمصداقية. من خلال شاحناتنا وفرق العمل الخاصة بنا، نبتعد عن العمالة العشوائية والرسوم الخفية، ونضمن لك شفافية كاملة والتزاماً تاماً من أول مكالمة.
            </p>
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mb-14">
            ...
            <p className="text-muted-foreground max-w-4xl text-sm md:text-base leading-relaxed">
              سواء تسميه نقل اثاث أو نقل عفش عجمان، نحن نقدم حلول نقل شاملة لكل أنواع المساحات وبأسعار معقولة تناسب ميزانيتك. من استوديو صغير لين فيلا كبيرة، ومن شقة برج لين مكتب في
              المنطقة الحرة. كل نوع نقل له متطلبات مختلفة في عدد العمال وحجم
              الشاحنة ونوع مواد التغليف، ونحرص على التخطيط الدقيق لكل نقلة.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              ...
              },
              {
                ...
                desc: "الفريق يوصل في الوقت المحدد بالضبط ويبدأون بحماية الأرضيات والممرات أول شي. بعدين يبدأون بتغليف القطع غرفة بغرفة — يبدأون من الغرف اللي ما تستخدمها كثير ويخلون المطبخ والحمام للآخر. الاثاث اللي يحتاج فك — مثل السراير والدواليب — يفكونه ويرقمون قطعه ويحطون البراغي في أكياس مرقمة. يفرشون الأرضيات في الممرات وعند الأبواب عشان الحمل ما يخدش شي.",
              },
              {
                title: "الخطوة 4 – التحميل والنقل بشاحنات مغلقة",
                desc: "بعد التغليف والفك، يحملون الاثاث في شاحنات مغلقة. نحن نستخدم فقط أحدث مواد التغليف والشاحنات المجهزة لضمان ثبات الحمولة وقت السير. القطع الثقيلة تنزل أول والخفيفة فوق. الشاحنة المغلقة تحمي أغراضك من الشمس والغبار والرطوبة — مهمة خصوصاً في صيف عجمان اللي ممكن تكسر فيه الحرارة 45 درجة. ما نستخدم بيك أب مفتوح لنقل الاثاث.",
              },
              {
