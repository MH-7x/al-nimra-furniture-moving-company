...
import { sharjahFaqs } from "@/lib/FaqsData";
...
export const metadata = MetadataTemplate({
  meta: {
    title: "نقل أثاث الشارقة | شركة النمرة نقل اثاث - 0541767605",
    desc: "شركة النمره لنقل اثاث الشارقة – فك وتغليف وتركيب مع تأمين شامل وشاحنات مغلقة. معاينة مجانية وعرض سعر فوري. اتصل الآن!",
  },
        ...
        <div className="relative max-w-5xl mx-auto">
          ...
          <div className="w-full aspect-video rounded-t-3xl overflow-hidden relative border-x border-t border-muted">
            <Image
              ...
              alt="شركة النمرة نقل اثاث نقل اثاث في الشارقة - شاحنة نقل أثاث أمام فيلا مع فريق عمل محترف"
              fill
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="space-y-6">
            ...
            <article className="grid grid-cols-1 md:grid-cols-2 gap-0 rounded-3xl overflow-hidden border border-muted">
              ...
              {/* 4:3 image */}
              <div className="aspect-4/3 md:aspect-auto relative order-1 md:order-2 ">
                <Image
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-0 divide-y md:divide-y-0 border border-muted rounded-3xl overflow-hidden bg-white">
            {[
              ...
              <div
                key={i}
                className="flex gap-5 p-6 md:p-7 border-b md:border-b border-muted last:border-b-0 md:odd:border-e"
              >
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="w-full aspect-video rounded-3xl overflow-hidden relative mb-10">
            <Image
              ...
              alt="تخزين أثاث في الشارقة - مستودعات النمرة نقل اثاث الآمنة لتخزين الأثاث"
              fill
              className="object-cover"
            />
          </div>
